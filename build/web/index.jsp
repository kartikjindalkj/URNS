...
<body id="reportsPage">
    <div class="" id="home">
        <nav class="navbar navbar-expand-xl">
            <div class="container h-100">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link d-block" href="login1.html">
                               Hello <br> <b>Logout</b>
                            </a>
                        </li>
                    </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <p class="text-white mt-5 mb-5">Welcome back, <b>Name</b></p>
                </div>
            </div>
            <!-- row -->
            <div class="row tm-content-row">
                <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 tm-block-col">
                    <div class="tm-bg-primary-dark tm-block">
                        <h2 class="tm-block-title">Upcoming Gatherings</h2>
...
ResultSet rs=stmt.executeQuery("SELECT * FROM gatherings");
while(rs.next())
{
...
%>
                            <div class="media tm-notification-item">
                                <div class="media-body">
                                    <p class="mb-2"><%= rs.getString("event") %></p>
                                    <span class="tm-small tm-text-color-secondary"><%= rs.getString("date") %></span><br>
                                    <span class="tm-small tm-text-color-secondary"><%= rs.getString("time") %></span>
                                </div>
                            </div>
    <%
...
%>
                ...
                <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 tm-block-col">
                    <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-overflow">
                        <h2 class="tm-block-title">Spotlight</h2>
                        <div class="tm-notification-items">
                            <%
try
{
...
ResultSet rs=stmt.executeQuery("SELECT * FROM spotlight");
while(rs.next())
{
...
%>
                            <div class="media tm-notification-item">
                                <div class="media-body">
                                    <p class="mb-2"><%= rs.getString("notification") %></p>
                                    <span class="tm-small tm-text-color-secondary"><a href="maintenance.jsp" class="tm-notication-link" style="color:white; a:hover{color: darkorange}"><%= rs.getString("details") %></a></span><br>
...
-->                        </div>
                ...
                <div class="col-12 tm-block-col">
                    <div class="tm-bg-primary-dark tm-block tm-block-taller ">
                        <h2 class="tm-block-title">Visitor log</h2>
...
ResultSet rs=stmt.executeQuery("SELECT * FROM visivisi");
while(rs.next())
{
