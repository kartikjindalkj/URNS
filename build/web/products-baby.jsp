...
ResultSet rs=stmt.executeQuery("SELECT * FROM product_baby");
while(rs.next())
{
...
%>
                  <tr>
                    ...
                    <td class="tm-product-name"><%= rs.getString("product_name") %></td>
...
%>
              <table class="table tm-table-small tm-product-table">
                <tbody>
                  <tr>
                    <td class="tm-product-name"><%= rs.getString("categories") %></td>
